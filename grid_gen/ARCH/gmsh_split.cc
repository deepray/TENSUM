      ...
      if(line == "$Periodic")
      {
         ...
         for(unsigned int p=0; p<p_elem; ++p)
         {
            ...
            if(e_dim == 0 || (e_dim == 1 && DIM == 3))
            {
			   ...
			   // itm1 = periodic_nodes.find(master);
// 			   if(itm1==periodic_nodes.end())
// 			   {
// 				  periodic_nodes.insert( pair<int,vector<int> >(master,inner));
// 			   }
//    
// 			   itm1 = periodic_nodes.find(slave);
// 			   if(itm1==periodic_nodes.end())
// 			   {
// 				  periodic_nodes.insert( pair<int,vector<int> >(slave,inner));
// 			   }
...
// 		    {
// 		        itm1 = periodic_nodes.find(*itv1);
// 		        (itm1->second).clear();
// 		        itm1->second = (*itvv1); 
// 		    }
// 		 }
//          
//          for(map<int, vector<int> >::iterator itm1 = periodic_nodes.begin();
//              itm1 != periodic_nodes.end(); ++itm1)
//          {
//              int v1 = itm1->first;
//              cout<<"MASTER "<<v1<<" --> ALL PERIODIC LINKS ";
//              for(vector<int>::iterator itv1 = (itm1->second).begin();
//                  itv1 != (itm1->second).end(); ++itv1)
//              {
//                 cout<<*itv1<<" ";
//              }  
//              cout<<endl;  
...
//          } 
   ...
   // if(periodic && !periodic_available)
//    {
//        cout<<"Error: Periodic flag used but no periodic data available in "<< grid_file <<endl;
//        exit(0);
//    }
}
